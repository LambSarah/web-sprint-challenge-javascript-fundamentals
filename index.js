...
/* nestedFunction() can access the variable internal because it is declared inside the myFunction() function, which is where internal is declared. Any private variables inside myFuction() are accessible until you are no longer inside that function because it belongs to that lexical/private scope.
...
function animalNames(zooAnimals) {
    // create array displayNames to hold our animal names
    const displayNames = [];
    // iterate through zooAnimals and add each animal's name and scientific name to displayNames 
    const names = zooAnimals.forEach((animal) => {
        displayNames.push(`name: ${animal.animal_name}, scientific: ${animal.scientific_name}`);
    });
    // return array of string containing display names 
    return displayNames;
}
...
function lowerCaseNames(zooAnimals) {
    // iterate through zooAnimals and for each animal add name string in lowercase to lowerCaseNames
    const lowerCaseNames = zooAnimals.map((animal) => {
        return animal.animal_name.toLowerCase();
    });
    //return array of strings containing lower case names
...
function lowPopulationAnimals(zooAnimals) {
    ...
    //return array of animal objects whose population < 5
 ...
 */
// Invoke callback function using a and b as arguments
...
// use firstName, lastName to return a greeting string
...
*/
// constructor function for CuboidMaker
...
// create volume function to CuboidMaker prototype object
...
// create surfaceArea method for CuboidMaker prototype object
...
// create a new CuboidMaker object named cuboid
